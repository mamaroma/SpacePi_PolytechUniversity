...
/* Группируем дискретные точки демо-датасета в осмысленные радиодиапазоны.
   ...
   Диапазоны подбирались так, чтобы основные радиостандарты уверенно попадали
   внутрь окна (а не лежали на самой границе). Поэтому узкие любительские
   полосы намеренно расширены до соседних служебных полос:
     • VHF любительский 144–146 МГц + морские/авиа на 118–137 МГц → 100–170 МГц
     • UHF ISM 433–437 МГц + 446 МГц PMR + 470 МГц UHF TV → 380–520 МГц
     • DECT 1880–1900 МГц + GPS L1 1575 МГц → 1500–2100 МГц новой полосой
     • Wi-Fi 2.4 ГГц 2400–2483 МГц + LTE 1800/2100/2600 → 2.0–2.7 ГГц
     • Wi-Fi 5 ГГц 5150–5825 МГц + LTE 5G n78 (3300–3800) → 3.0–6.0 ГГц
*/
const BAND_RANGES = [
  { id: "all",       label: "Весь спектр",         from: 0,     to: 100000, hint: "все наблюдаемые источники" },
  { id: "vhf-low",   label: "VHF · 100–170 МГц",   from: 100,   to: 170,    hint: "FM-радио, авиадиапазон 118–137, морские 156–162, любители 144–146" },
  { id: "uhf-low",   label: "UHF · 380–520 МГц",   from: 380,   to: 520,    hint: "TETRA 380–400, 433/446 МГц ISM/PMR, любители 430–440, CubeSat 437" },
  { id: "iot-eu",    label: "SRD/LoRa EU · 800–960 МГц", from: 800, to: 960, hint: "GSM 900, LoRa 863–870, RFID/SRD, цифр. ТВ DVB-T2 700–862" },
  { id: "iot-us",    label: "ISM/LTE · 902–960 МГц",      from: 880, to: 960, hint: "LTE 900, GSM, LoRa US 902–928, RFID 866–960" },
  { id: "gsm-dect",  label: "L-band · 1.5–2.1 ГГц",       from: 1500, to: 2100, hint: "GPS L1 1575, GSM 1800, UMTS 1920–2170, DECT 1880–1900" },
  { id: "shf-24",    label: "Wi-Fi/LTE · 2.0–2.7 ГГц",    from: 2000, to: 2700, hint: "UMTS 2100, Wi-Fi/BT 2400–2483, LTE B7 2600, ISM 2.4" },
  { id: "shf-58",    label: "Wi-Fi 5/5G · 3.0–6.0 ГГц",   from: 3000, to: 6000, hint: "5G n78 3.3–3.8, Wi-Fi 5 ГГц 5150–5825, спутник C-band" },
];
